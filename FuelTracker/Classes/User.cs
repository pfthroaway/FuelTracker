...
namespace FuelTracker
{
    ...
    public class User : IEnumerable<Vehicle>, INotifyPropertyChanged
    {
        private int _id;
        ...
        private static bool Equals(User left, User right)
        {
            ...
            return left.ID == right.ID && string.Equals(left.Username, right.Username, StringComparison.OrdinalIgnoreCase) && string.Equals(left.Password, right.Password, StringComparison.Ordinal) && left.Vehicles == right.Vehicles;
        }
